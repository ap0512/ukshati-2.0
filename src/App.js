    ...
    <>
      <Suspense fallback={<div>Loading...</div>}>
        <Routes>
          ...
          <Route path="/Uno" element={<DeviceProtectedRoute requiredDevice="UNO"><Uno /></DeviceProtectedRoute>} />
          <Route path="/Hexa" element={<DeviceProtectedRoute requiredDevice="HEXA"><Hexa /></DeviceProtectedRoute>} />
