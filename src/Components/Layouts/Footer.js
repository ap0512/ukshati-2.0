...
import { FaFacebook, FaTwitter, FaLinkedin, FaYoutube, FaAndroid, FaInstagram, FaMapMarker, FaEnvelope, FaPhone } from 'react-icons/fa';
  ...
  return (
    <footer className="bg-gray-900 text-white text-sm">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div>
            ...
            <p className="text-gray-300">
              Ukshati (उक्षति sprinkle water) System is a watering automation service provider. We automate the process of watering for various setups, from large gardens to small balconies.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="flex items-center text-gray-300"><FaMapMarker className="mr-2" /> Ukshati Technologies Pvt Ltd, Pramod Towers, Mangaluru, Karnataka 575002</p>
            <p className="flex items-center text-gray-300 mt-2"><FaEnvelope className="mr-2" /> ukshati365@gmail.com</p>
            <p className="flex items-center text-gray-300 mt-2"><FaPhone className="mr-2" /> +91 8861567365</p>
          </div>
        </div>
      </section>
      ...
      <div className="text-center py-3 bg-gray-800">
        <span className="text-gray-400">© 2021 <span className="text-green-400">Ukshati Technologies</span>. All rights reserved.</span>
      </div>
    </footer>
  );
};
